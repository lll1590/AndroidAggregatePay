...
//        mWXApi.handleIntent(mActivity.getIntent(), this);
	...
	public static class Builder{
		...
		public Builder setOnWechatPayListener(OnPayListener onWechatPayListener) {
		...
		public WechatPayReq create(){
			...
			//监听
			wechatPayReq.mOnWechatPayListener = this.mOnWechatPayListener;
...
//            		this.mOnWechatPayListener.onPaySuccess(1, "支付成功");
//            	}else{//  -1	错误       -2	用户取消
//            		this.mOnWechatPayListener.onPayFailure(2, "支付失败");
//            	}
//            }
//        }
//	}
